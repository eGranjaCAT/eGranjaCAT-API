...
namespace eGranjaCAT.Infrastructure.Services
{
    public interface IEntradaService
    {
        ...
        Task<ServiceResult<bool>> DeleteEntradaAsync(int entradaId);
        ...
        Task<ServiceResult<PagedResult<GetEntradaDTO>>> GetEntradesAsync(int pageIndex, int pageSize);
        Task<ServiceResult<PagedResult<GetEntradaDTO>>> GetEntradesByFarmAsync(int farmId, int pageIndex, int pageSize);
        Task<ServiceResult<bool>> UpdateEntradaAsync(int entradaId, UpdateEntradaDTO updateEntradaDTO);
    }
}